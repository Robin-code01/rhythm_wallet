...
function getEntries({state, setState}, search, playlist_id) {

  fetch(`${API}/entries/playlist/${playlist_id}/?q=${search}`, {
    method: 'GET',
    headers: {
...
export default function Create() {
  const [state, setState] = useState({
    ...
    let playlist_id = urlSegments.pop();
    while (playlist_id === "") {
    playlist_id = urlSegments.pop();
    }
